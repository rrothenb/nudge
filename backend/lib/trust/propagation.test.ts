...
describe('Trust Propagation', () => {
  describe('propagateTrust', () => {
    ...
    it('should propagate trust through multiple hops', () => {
      ...
      graph.addEdge('user1', 'user2', 0.8, 'direct');
      graph.addEdge('user2', 'user3', 0.9, 'direct');
    ...
    it('should handle multiple trust sources', () => {
      ...
      graph.addNode('target', 'user', 0.0);

      // Both trust the target
      graph.addEdge('user1', 'target', 0.7, 'direct');
      graph.addEdge('user2', 'target', 0.6, 'direct');
    ...
    it('should respect max depth limit', () => {
      ...
      for (let i = 2; i <= 5; i++) {
        ...
        graph.addEdge(`user${i - 1}`, `user${i}`, 0.9, 'direct');
      }
  ...
  describe('computeUserTrustForTarget', () => {
    ...
    it('should compute trust through intermediaries', () => {
      ...
      graph.addEdge('user1', 'user2', 0.9, 'direct');
      graph.addEdge('user2', 'user3', 0.8, 'direct');
  ...
  describe('findTrustPaths', () => {
    ...
    it('should find multiple paths', () => {
      ...
      graph.addEdge('user1', 'user2', 0.8, 'direct');
      graph.addEdge('user2', 'target', 0.7, 'direct');
      graph.addEdge('user1', 'user3', 0.6, 'direct');
      graph.addEdge('user3', 'target', 0.9, 'direct');
